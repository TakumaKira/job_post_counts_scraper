...
class TestDB:
    ...
    @patch.dict(os.environ, {"FUNCTION_ENVIRONMENT": "aws_lambda", "AWS_DB_SECRETS_NAME": "aws/secret/name", "AWS_REGION": "aws-region", "AWS_RDS_ENDPOINT": "rds.proxy.host"})
    def test_get_db_url_returns_correct_in_aws_lambda_environment(self):
        ...
        assert get_db_url() == 'postgresql+psycopg2://user:pass@rds.proxy.host:5432/db?sslmode=require'
